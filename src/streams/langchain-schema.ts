...
export type LangChainMessageContentText = z.infer<typeof LangChainMessageContentTextSchema>;
...
export type LangChainMessageContentImageUrl = z.infer<typeof LangChainMessageContentImageUrlSchema>;
...
export const LangChainMessageContentComplexSchema = z.union([
  ...
  z
    .object({
      type: z.union([z.literal("text"), z.literal("image_url"), z.string()]).optional(),
    })
    .catchall(z.any()),
  z
    .object({
...
export type LangChainMessageContentComplex = z.infer<typeof LangChainMessageContentComplexSchema>;

export const LangChainMessageContentSchema = z.union([z.string(), z.array(LangChainMessageContentComplexSchema)]);
export type LangChainMessageContent = z.infer<typeof LangChainMessageContentSchema>;

export const LangChainAIMessageChunkSchema = z.object({
  content: LangChainMessageContentSchema,
});
export type LangChainAIMessageChunk = z.infer<typeof LangChainAIMessageChunkSchema>;
...
export type LangChainIntermediateStreamEventSchema = z.infer<typeof LangChainIntermediateStreamEventSchema>;
