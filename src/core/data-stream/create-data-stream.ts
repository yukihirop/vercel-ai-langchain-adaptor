...
export function createDataStream({
  ...
  try {
    ...
    // biome-ignore lint/style/noNonNullAssertion: Non-null assertion is necessary
    controller!.enqueue(formatDataStreamPart("error", onError(error)));
  }
  ...
  // from callbacks.
  // biome-ignore lint/suspicious/noAsyncPromiseExecutor: We need to use an async executor here
